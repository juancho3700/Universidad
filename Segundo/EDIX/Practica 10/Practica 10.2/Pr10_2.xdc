...
## Switches
set_property PACKAGE_PIN V17 [get_ports A_in]
set_property IOSTANDARD LVCMOS33 [get_ports A_in]

set_property PACKAGE_PIN V16 [get_ports B_in]
...
## LEDs
set_property PACKAGE_PIN U16 [get_ports z1]
set_property IOSTANDARD LVCMOS33 [get_ports z1]

set_property PACKAGE_PIN E19 [get_ports z2]
