...
subplot(211), semilogx(t,senal), xlabel('t (s)'), ylabel('amplitud'), axis tight;
subplot(212), semilogx(fHz,20*log10(mfss)), xlabel('f (Hz)'), ylabel('Magnitud (dB)'),axis([0 4000 -60 10]);
